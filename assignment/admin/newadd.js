    ...
    render() {
        ...
        <nav class="text-white text-base font-semibold pt-3 ">
            ...
            <div class="md:col-span-1">
                ...
                <h3 class="text-3xl ml-[30px] mt-[20px] font-bold leading-6 text-gray-900">Add Profile</h3>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" name="company-website" id="company-website" class="shadow-sm p-[10px] focus:ring-indigo-500 focus:border-indigo-500 mt-1 block sm:text-sm border border-gray-300 rounded-md" placeholder="">
                        </div>
                        </div>
                    </div>
