const Signin = {
    render() {
        ...
        <div class="bg-[#cad2c5] my-[20px] border-[1px] h-[50rem] w-[55rem] ml-[15%] rounded-2xl">
        <div class="py-[10px] text-3xl font-bold text-center mt-[20px]">Sign in to your account</div>
    
        <div class=" border-[2px] w-[51rem] h-[40.5rem] ml-[2rem] mt-[2rem] rounded-2xl">
            <form action="" class="ml-[0px] mt-[20px]">
                <div class="flex justify-around">
                    <div class="">
                        <label for="" class="block text-xl my-[10px]">First Name</label>
                ...
                <div class="flex justify-around">
                    <div class="">
                        <label for="" class="block text-xl my-[10px]">Last Name</label>
                        <input type="text" placeholder="" class="block w-[20rem] border-black rounded-[5px] p-[7px] border-[1px] my-[10px] ">
                    </div>
                    <div class="">
                ...
                <div class="flex justify-around">
                    <div class="">
                        <label for="" class="block text-xl my-[10px]">Phone Number</label>
                        <input type="text" placeholder="" class="block w-[20rem] border-black rounded-[5px] p-[7px] border-[1px] my-[10px] ">
                    </div>
                    <div class="">
                        <label for="" class="block text-xl my-[10px]">Enter the password</label>
                        <input type="text" placeholder="" class="block w-[20rem] border-black rounded-[5px] p-[7px] border-[1px] my-[10px] ">
                    </div>
                </div>

                <div class="mt-[50px] ml-[13rem]">
                    <input type="submit" value="Sign in" class="p-[10px] border-[1px] bg-[#0253a4] text-2xl text-[#fff] rounded-lg w-[25rem]">
                </div>
            </form>
            <div class="flex ml-[20rem] text-[#03045e] text-sm mt-[20px]">
                        <a href="/login">Do you already have an account ?</a>
            </div>
            <div class="text-sm text-[#0253a4] ml-[16rem] mt-[20px]">------------------ Or continue with ------------------</div>
